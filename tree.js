...
var data = [
    ...
    { "name": "Madison Benson", 		"class": "2021 BΩ", "active": "y", "parent": "Liam Wallace"},
    ...
    { "name": "Thong Dinh", 			"class": "2021 BΩ", "active": "y", "parent": "Erica Vellanoweth"},
    { "name": "Amaya Fogg", 			"class": "2021 BΩ", "active": "n", "parent": "Monica Quevedo"},
    { "name": "Anna Johnson", 			"class": "2021 BΩ", "active": "y", "parent": "Cameron Uy"},
    { "name": "Connor Lantz", 			"class": "2021 BΩ", "active": "y", "parent": "Adam Traut"},
    { "name": "Alannah Linden", 		"class": "2021 BΩ", "active": "y", "parent": "Gina Talcott"},
    { "name": "Brendan Lockie", 		"class": "2021 BΩ", "active": "y", "parent": "Colin McClure"},
    { "name": "Angel Lopez", 			"class": "2021 BΩ", "active": "y", "parent": "Fidel Negrete"},
    { "name": "Jack Nelson", 			"class": "2021 BΩ", "active": "y", "parent": "Renee Shanteler"},
    { "name": "Sheryl Ocampo", 			"class": "2021 BΩ", "active": "y", "parent": "Sydney Myers"},
    ...
    { "name": "Nicholas Washburn", 		"class": "2021 BΩ", "active": "y", "parent": "Brianna Becerra"},
    { "name": "Vivian Yee", 			"class": "2021 BΩ", "active": "y", "parent": "Bryan Jefferson"},
    ...
    { "name": "Danny Merida",			"class": "2022 ΓA", "active": "y", "parent": "Brendan Lockie"},
...
function update(source) {
	...
	.style("fill", function(d) { 
	    if ( d._children )
		return "royalblue";
	    if ( d.class === "2022 ΓA" )               //Change this for color of candidate class
		return "#C2E0FF";
	    if ( d.active === "y" )
		return "gold";
	    return "#fff"; });
